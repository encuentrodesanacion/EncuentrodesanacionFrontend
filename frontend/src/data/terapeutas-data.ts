...
"Fernanda Arce como Terapeuta Holística Integral guía a sus consultantes a reencontrarse con su paz interior y su alma utilizando herramientas como el tarot, los registros Akashicos, Reiki, péndulo hebreo y terapias vibracionales. Utiliza poderosas técnicas para el despertar y la reconfiguración mental: •  Conexión Profunda: Su experiencia en Programación Neurolingüística (PNL), Hipnosis y Regresión permite desmantelar patrones limitantes desde la raíz y liberar bloqueos profundos. •  Sanación Vibracional: Restaura el equilibrio del cuerpo energético mediante Reiki, Tameana, sonoterapia, péndulo hebreo, entre otras. ",
...

{
 ...
 description:
   ...
   "Reconecta con la sabiduría de tu Alma ¿Sientes que repites patrones sin entender por qué? ¿Buscas claridad sobre tu propósito o una guía ante una decisión importante? En una lectura de Registros Akáshicos, accedemos a la biblioteca energética de tu alma para obtener las respuestas que necesitas hoy. No es solo información; es una frecuencia de sanación que te permite soltar bloqueos y avanzar con total confianza. Modalidad: Video llamada o audios de WhatsApp. Aclara tu camino, sana tu presente y recuerda quién viniste a ser.",
...

{
 ...
 description:
   ...
   "Respuestas para sanar. Si estás atravesando una crisis, un bloqueo emocional o una duda existencial, el Tarot Terapéutico te ofrece una hoja de ruta. En esta sesión: • Analizamos la raíz emocional de tu situación actual. • Descubrimos tus recursos internos para superar obstáculos. • Trazamos un plan de acción consciente alineado con tu bienestar. Modalidad: Video llamada o audios de WhatsApp. No esperes a que el destino decida por ti. Toma consciencia y elige tu camino.",
...

{
 ...
 description:
   ...
   "Libera tu carga y recupera tu equilibrio ¿Sientes el ambiente pesado, cansancio inexplicable o que las cosas no fluyen a pesar de tus esfuerzos? Al igual que cuidamos nuestra higiene física, nuestro campo energético necesita purificarse. A través de una Limpieza Energética, eliminamos densidades, bloqueos y vibraciones estancadas en tu aura o en tus espacios. Recupera la vitalidad, la paz mental y permite que la energía positiva vuelva a circular en tu vida. Modalidad, video llamada o audios de WhatsApp. Vuelve a vibrar alto. Siéntete ligero de nuevo.",
