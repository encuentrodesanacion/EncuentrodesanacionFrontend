...
import conexionemo from "../assets/terapiapar.png";
...
export const terapeutasData: Terapeuta[] = [
  ...
  // },
  {
    ...
    imagenPerfil: belen,
    callToActionTextCard:
      "Te ayudo a fortalecer tu relación de pareja, mejorando la conexión emocional a través de la Escritura Terapéutica.",
    servicios: [
      {
        img: conexionemo,
