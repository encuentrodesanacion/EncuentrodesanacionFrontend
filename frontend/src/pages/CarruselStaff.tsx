...
const staffData: Record<string, StaffMember[]> = {
  ...
  Básico: [
    { nombre: "Ana Luisa Solervicens", url: "https://www.instagram.com/susurro_ancestralcl/", imagen: anaLuisa, descripcion: "Las lecturas de runas están orientadas a entregar claridad, guía y comprensión profunda de los procesos que estás viviendo. A través de la sabiduría ancestral nórdica, la intuición terapéutica y un espacio de escucha consciente, te acompaño a reconocer bloqueos, tomar decisiones con mayor seguridad y reconectar con tu propósito. Cada lectura es un encuentro respetuoso y personalizado, enfocado en abrir caminos y traer luz a tu presente." },
