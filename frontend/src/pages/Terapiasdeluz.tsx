...
export default function Terapias() {
  ...
  const [currentTerapia, setCurrentTerapia] = useState<ImagenData | null>(null);
  ...
  const handleConfirmAndAddToCart = () => {
    ...
    const nuevaReserva: Reserva = {
      id: Date.now(),
      servicio: "Formación de Terapeutas de la Luz",
      especialidad: currentTerapia.alt,
      fecha: fechaActual,
      hora: horaGenerica,
      precio: currentTerapia.precio,
      terapeuta: currentTerapia.terapeuta,
      terapeutaId: currentTerapia.terapeutaId, // <-- CORRECCIÓN APLICADA
